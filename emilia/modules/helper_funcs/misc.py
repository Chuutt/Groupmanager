...
def paginate_modules(page_n: int, module_dict: Dict, prefix, chat=None) -> List:
    ...
    if len(pairs) > 4:
        pairs = pairs[modulo_page * 4:4 * (modulo_page + 1)] + [
            (EqInlineKeyboardButton("⬅️ Previ", callback_data="{}_prev({})".format(prefix, modulo_page)),
            EqInlineKeyboardButton("Close 🗑️", callback_data="{}_prev({})".format(prefix, modulo_page)),
